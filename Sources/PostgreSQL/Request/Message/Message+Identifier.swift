    ...
    enum Identifier: CustomStringConvertible, Equatable, ExpressibleByIntegerLiteral {
        ...
        init(integerLiteral value: UInt8) {
            ...
            case 0x32:
                self = .bindComplete
            case 0x43:
                self = .close // Other options: .commandComplete
            case 0x33:
                self = .closeComplete
            case 0x57:
            ...
            case 0x47:
                self = .copyInResponse
            case 0x48:
                self = .copyOutResponse // Other options: .flush
            case 0x44:
                self = .dataRow // Other options: .describe
            case 0x49:
                self = .emptyQueryResponse
            case 0x45:
                self = .errorResponse // Other options: .execute
            case 0x46:
                self = .functionCall
            case 0x56:
            ...
            case 0x53:
                self = .parameterStatus // Other options: .sync
            case 0x50:
                self = .parse
            case 0x31:
                self = .parseComplete
